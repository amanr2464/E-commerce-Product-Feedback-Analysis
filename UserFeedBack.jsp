<%--
    ...
    Created on : NOV 22, 2017, 4:57:54 PM
    Author     : 
--%>
...
//the below code will be taken from feedback page for condition satisfying
        </script>
        <script type="text/javascript">
            function contact(i)
            {
                ...
                <td bgcolor="white"  align="center">
                        ...
                        <table align="center" cellpadding="3" cellspacing="3">
                            ...
                            <link rel="stylesheet" href="//netdna.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
                                <link rel="stylesheet" href="ajax/stylesheet.css"><!--link with css stylesheet-->
                             <form action="save_comment.jsp" method="post">
                                            <table class="">
                                                ...
                                                <center><div class="stars">
                                                        ...
                                                        <label class="star star-1" for="star-1"></label><!--label tags is used into it-->
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <button type="submit" >Submit</button><!--submit button is maked-->
                                                        </td>
                                                    </tr>
                                        ...
                                        </form><!--clossing all the tags-->
                   
                </td>
            </tr>
            <tr>
                <td height="50" colspan="2" align="center" class="toplinls" width="100%">
                    <span class="whitefont">Online Shopping</span><!--Online shopping is shown bottom of the page (in center)-->
                </td>
            </tr>
        </table>
    </body>
